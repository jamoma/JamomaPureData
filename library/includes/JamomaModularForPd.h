 ...
 *
 * @authors Théo de la Hogue, Tim Place, Antoine Villeret
 *
...
#ifndef __JAMOMA_MODULAR_FOR_PD_H__
#define __JAMOMA_MODULAR_FOR_PD_H__
...
extern JAMOMA_EXPORT	TTRegex*			ttRegexForPdpat;		///< A global regex to parse .maxpat
extern JAMOMA_EXPORT	TTRegex*			ttRegexForPdhelp;		///< A global regex to parse .maxhelp
