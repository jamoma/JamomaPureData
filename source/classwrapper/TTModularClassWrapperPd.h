/** @file
 *
 * @ingroup implementationPd
 *
 * @brief Wraps Jamoma Core classes as objects for PureData
 *
 * @details
 *
...
#ifndef __TT_MODULAR_CLASS_WRAPPER_PD_H__
#define __TT_MODULAR_CLASS_WRAPPER_PD_H__

#include "TTClassWrapperPd.h"

#include "TTModular.h"              // Jamoma Modular API
#include "JamomaForPd.h"           // Jamoma for Pd
