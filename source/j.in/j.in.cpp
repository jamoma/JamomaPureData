...
/** bang handler for j.in 
 @param self		Pointer to this object.
 @see				in_float, in_list, WrappedInputClass_anything
 */
...
/** float handler for j.in 
 ...
 @see				in_bang, in_list, WrappedInputClass_anything
 */
...
/** list handler for j.in 
 ...
 @param argc		The number of arguments passed to the object.
 @param argv		Pointer to an array of atoms passed to the object.
 @see				in_bang, in_float, WrappedInputClass_anything
 */
...
extern "C" void JAMOMA_EXPORT_MAXOBJ setup_j0x2ein(void)
{
...
#ifdef J_IN_TILDE
    return (void)wrapTTModularClassAsPdClass(kTTSym_InputAudio, "j.in~", NULL, spec);
#endif
...
#ifndef J_IN_TILDE
#ifndef J_IN_MULTI
    return (void)wrapTTModularClassAsPdClass(kTTSym_Input, "j.in", NULL, spec);
#endif
#endif
...
void WrapTTInputClass(WrappedClassPtr c)
{
    eclass_addmethod(c->pdClass, (method)in_assist,						"assist",				A_CANT, 0L);
	
#ifdef J_IN_TILDE
    eclass_addmethod(c->pdClass, (method)in_dsp64,						"dsp64",				A_CANT, 0);
#endif
    
#ifdef J_IN_MULTI
    eclass_addmethod(c->pdClass, (method)in_reset,                      "audio.reset",          A_CANT, 0);
    eclass_addmethod(c->pdClass, (method)in_setup,                      "audio.setup",          A_CANT, 0);
    eclass_addmethod(c->pdClass, (method)in_connect,                    "audio.connect",        A_OBJ, A_LONG, 0);
#endif
    
#ifndef J_IN_TILDE
#ifndef J_IN_MULTI
    eclass_addmethod(c->pdClass, (method)in_return_signal,				"return_signal",		A_CANT, 0);
	
    eclass_addmethod(c->pdClass, (method)in_bang,						"bang", 				A_NULL, 0L);
    eclass_addmethod(c->pdClass, (method)in_float,						"float", 				A_FLOAT, 0L);
    eclass_addmethod(c->pdClass, (method)in_list,						"list", 				A_GIMME, 0L);
    // eclass_addmethod(c->pdClass, (method)NULL,					"loadbang", 			A_NULL,  0L);
#endif
#endif
...
void in_subscribe(TTPtr self)
{
    ...
    if (!jamoma_subscriber_create((t_eobj*)x, x->wrappedObject, inputAddress, x->subscriberObject, returnedAddress, &returnedNode, &returnedContextNode)) {
...
void in_return_signal(TTPtr self, t_symbol *msg, long argc, t_atom *argv)
{
	...
	if (msg == _sym_nothing)
        outlet_anything((t_outlet*)x->outlets[signal_out], NULL, argc, argv);
	else
        outlet_anything((t_outlet*)x->outlets[signal_out], msg, argc, argv);
}
#endif
#endif
