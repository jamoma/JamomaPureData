...
extern "C" void JAMOMA_EXPORT_MAXOBJ setup_j0x2eui(void){
	long	flags;
    t_eclass *c;
    ...
    eclass_addmethod(c, (method)ui_notify,							"notify",							A_CANT, 0);
    eclass_addmethod(c, (method)ui_paint,							"paint",							A_CANT, 0);
    eclass_addmethod(c, (method)ui_mousedown,						"mousedown",						A_CANT, 0);
    eclass_addmethod(c, (method)ui_mousedragdelta,					"mousedragdelta",					A_CANT, 0);
    eclass_addmethod(c, (method)ui_mouseup,							"mouseup",							A_CANT, 0);
    eclass_addmethod(c, (method)ui_mousemove,						"mousemove",						A_CANT, 0);
    eclass_addmethod(c, (method)ui_mouseleave,						"mouseleave",						A_CANT, 0);
    eclass_addmethod(c, (method)ui_oksize,							"oksize",							A_CANT, 0);
    
    eclass_addmethod(c, (method)ui_edit_state,                       "dblclick",                         A_CANT, 0);
    eclass_addmethod(c, (method)ui_edclose,                          "edclose",                          A_CANT, 0);
	
    eclass_addmethod(c, (method)ui_modelParamExplorer_callback,		"return_modelParamExploration",		A_CANT, 0);
    eclass_addmethod(c, (method)ui_modelMessExplorer_callback,		"return_modelMessExploration",		A_CANT, 0);
    eclass_addmethod(c, (method)ui_modelRetExplorer_callback,		"return_modelRetExploration",		A_CANT, 0);
	
    eclass_addmethod(c, (method)ui_return_model_address,				"return_model_address",				A_CANT, 0);
	
    eclass_addmethod(c, (method)ui_return_model_init,				"return_model_init",				A_CANT, 0);
    
    eclass_addmethod(c, (method)ui_return_model_content,             "return_model_content",             A_CANT, 0);
	
    eclass_addmethod(c, (method)ui_return_mute,						"return_mute",						A_CANT, 0);
    eclass_addmethod(c, (method)ui_return_bypass,					"return_bypass",					A_CANT, 0);
    eclass_addmethod(c, (method)ui_return_mix,						"return_mix",						A_CANT, 0);
    eclass_addmethod(c, (method)ui_return_gain,						"return_gain",						A_CANT, 0);
    eclass_addmethod(c, (method)ui_return_freeze,					"return_freeze",					A_CANT, 0);
    eclass_addmethod(c, (method)ui_return_active,					"return_active",					A_CANT, 0);
    eclass_addmethod(c, (method)ui_return_preset_names,				"return_preset_names",				A_CANT, 0);
